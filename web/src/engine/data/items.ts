...
export type ConsumableEffect =
  ...
  | { type: 'witchwick' }; // v11: burn it to walk home from anywhere in a gate
...
export const CONSUMABLES: Record<string, ConsumableDef> = {
  ...
  Witchwick: {
    ...
    emoji: '🕯️',
    price: 45,
    description: 'A candle stub, wick blackened with old use. Burn it anywhere in a gate and the dusk walks you home. One use.',
    effect: { type: 'witchwick' },
  },
};
