...
export const NPCS: NpcDef[] = [
  ...
  },
  {
    ...
    greetings: [
      [
        'Come in out of the dark, dear. It has enough to eat without you.',
        'My husband would have liked you. He liked anyone the monsters liked.',
      ],
      [
        'You brought the straw some meaning again, dear. The stable creaks happier now.',
        'One orb home. He always said the first one would be the hardest. He said that about everything.',
      ],
      ['The house is less loud with quiet these days, dear. That is your doing.'],
      [
        'Three orbs. I put flowers out. First time the windowsill has had a job in years.',
        'I dreamt of him last night and he was smiling. Take that for the thanks it is.',
      ],
      ['I knitted you something. It is not much. Neither is a candle, until the dark comes.'],
      [
        'Dawn on the stable roof, dear. He is somewhere being insufferably right about you.',
        'Sit with me a moment. The quiet is the good kind now, and good quiet is for sharing.',
      ],
    ],
    rumors: [
      'My husband spoke of {beast} only once, dear, and then only to the fire. He thought I was asleep. I let him think it.',
      'He kept a drawing of {artifact} folded in his boot. Said it was waiting in the {artifactGate} for somebody kinder than him.',
      'His grandmother tamed in {era}, when the beasts came when called. Some still remember being called, she said.',
      'A tamer named {figure} stabled here once, long before me. The stall they used stays warm. I have stopped explaining it.',
      'The wives by the well say {beast} takes the unloved first. So be loved, dear. It is cheap armor, but it is armor.',
    ],
  },
  {
    id: 'ott',
